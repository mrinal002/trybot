...
client.on('message', async msg => {
  ...
  if (command === 'radio') {
    ...
    if (args[1] === undefined) {
      radio.playRadio(msg.member.voiceChannel, msg, 'I LOVE RADIO', 'http://192.240.102.133:11454/stream.mp3')
    }

    // I LOVE THE BATTLE - Web radio
    if (args[1] === '1') {
      radio.playRadio(msg.member.voiceChannel, msg, 'I LOVE THE BATTLE', 'http://192.240.102.133:11454/stream.mp3')
    }

    // I LOVE #DREIST - Web radio
    if (args[1] === '2') {
      radio.playRadio(msg.member.voiceChannel, msg, 'I LOVE #DREIST', 'http://192.240.102.133:11454/stream.mp3')
    }

    // I LOVE TOP 100 CHARTS - Web radio
    if (args[1] === '3') {
      radio.playRadio(msg.member.voiceChannel, msg, 'I LOVE TOP 100 CHARTS', 'http://118.179.219.244:8000')
    }

    // I LOVE BASS - Web radio
    if (args[1] === '4') {
      radio.playRadio(msg.member.voiceChannel, msg, 'I LOVE THE DJ BY DJ MAG', 'http://118.179.219.244:8000')
    }
  }
